# nvim-treesitter-queries-tcl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tcl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tcl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tcl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tcl",
...
- [ ] Changes are scoped to `tcl` — do not include files for other languages
